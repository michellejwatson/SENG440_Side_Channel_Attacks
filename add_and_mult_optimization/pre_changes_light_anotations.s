	...
	.eabi_attribute 30, 6
	.eabi_attribute 18, 4
	.file	"if_exponentiation_optimization.c"
	.text
	.align	2
...
.L11:
	...
	cmp	r3, #0
	beq	.L8
	ldmib	fp, {r3-r4} 	@ extra work starts here if not 0
	stmia	sp, {r3-r4}
	sub	r1, fp, #28
	ldmia	r1, {r0-r1}
	sub	r3, fp, #36
	ldmia	r3, {r2-r3}
	bl	montgomery_add		@ whole extra add function
	mov	r3, r0
	mov	r4, r1
	str	r3, [fp, #-28]
	str	r4, [fp, #-24]		
.L8:						@ extra work ends
	...
	ldr	r3, [fp, #-32]
	cmp	r2, r3
	bhi	.L9					@ checks for whether or not to enter second if()
	ldr	r2, [fp, #8]
	ldr	r3, [fp, #-32]
	cmp	r2, r3
	bne	.L13
	...
	ldr	r3, [fp, #-36]
	cmp	r2, r3
.L13:						@ unbalanced work (innards of second if())
	ldmib	fp, {r3-r4}
	stmia	sp, {r3-r4}
	sub	r1, fp, #36
	ldmia	r1, {r0-r1}
